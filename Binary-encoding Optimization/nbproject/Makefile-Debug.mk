...
${OBJECTDIR}/Sources/Binary_Reformulation.o: Sources/Binary_Reformulation.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DIL_STD -I/home/p/payman/Gurobi/gurobi902/linux64/include -IHeaders -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Binary_Reformulation.o Sources/Binary_Reformulation.cpp

${OBJECTDIR}/Sources/Multiplication.o: Sources/Multiplication.cpp
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DIL_STD -I/home/p/payman/Gurobi/gurobi902/linux64/include -IHeaders -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Multiplication.o Sources/Multiplication.cpp

${OBJECTDIR}/Sources/Optimizations.o: Sources/Optimizations.cpp
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DIL_STD -I/home/p/payman/Gurobi/gurobi902/linux64/include -IHeaders -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Optimizations.o Sources/Optimizations.cpp

${OBJECTDIR}/Sources/Reading_LP_file.o: Sources/Reading_LP_file.cpp
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DIL_STD -I/home/p/payman/Gurobi/gurobi902/linux64/include -IHeaders -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Reading_LP_file.o Sources/Reading_LP_file.cpp

${OBJECTDIR}/Sources/Solution_Vector.o: Sources/Solution_Vector.cpp
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DIL_STD -I/home/p/payman/Gurobi/gurobi902/linux64/include -IHeaders -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Solution_Vector.o Sources/Solution_Vector.cpp

${OBJECTDIR}/Sources/Write_Output.o: Sources/Write_Output.cpp
	${MKDIR} -p ${OBJECTDIR}/Sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DIL_STD -I/home/p/payman/Gurobi/gurobi902/linux64/include -IHeaders -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sources/Write_Output.o Sources/Write_Output.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -DIL_STD -I/home/p/payman/Gurobi/gurobi902/linux64/include -IHeaders -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
